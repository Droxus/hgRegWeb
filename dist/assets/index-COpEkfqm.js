(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function n(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(a){if(a.ep)return;a.ep=!0;const i=n(a);fetch(a.href,i)}})();console.log("Hello router handler!");function z(e){const t=document.querySelector("#app");for(;t.firstChild;)t.removeChild(t.firstChild);const n=document.createElement("div");n.id="message",n.innerText=e,document.body.appendChild(n)}async function vt(e){console.log(`Order ${e} is being canceled.`);const t="https://hg-registration-bot-cd9ed03a6bc5.herokuapp.com/cancelorder";try{const n=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({orderId:e})}),r=await n.json();n.ok?(console.log("Data saved successfully:",r),z("Ваш заказ отменен.")):(console.error("Failed to save data:",r),z("Ваш заказ отменен."))}catch(n){console.error("Error:",n),z("Ваш заказ отменен.")}}function It(){const t=new URLSearchParams(window.location.search).get("cancelorderid");t&&vt(t)}It();var ue={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt="FirebaseError";class B extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=Rt,Object.setPrototypeOf(this,B.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,k.prototype.create)}}class k{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},a=`${this.service}/${t}`,i=this.errors[t],s=i?Ht(i,r):"Error",o=`${this.serviceName}: ${s} (${a}).`;return new B(a,o,r)}}function Ht(e,t){return e.replace(Pt,(n,r)=>{const a=t[r];return a!=null?String(a):`<${r}?>`})}const Pt=/\{\$([^}]+)}/g;function P(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const a of n){if(!r.includes(a))return!1;const i=e[a],s=t[a];if(he(i)&&he(s)){if(!P(i,s))return!1}else if(i!==s)return!1}for(const a of r)if(!n.includes(a))return!1;return!0}function he(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const da="firebase-installations-database",ua=1,D="firebase-installations-store";let Y=null;function se(){return Y||(Y=je(da,ua,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(D)}}})),Y}async function M(e,t){const n=q(e),a=(await se()).transaction(D,"readwrite"),i=a.objectStore(D),s=await i.get(n);return await i.put(t,n),await a.done,(!s||s.fid!==t.fid)&&rt(e,t.fid),t}async function st(e){const t=q(e),r=(await se()).transaction(D,"readwrite");await r.objectStore(D).delete(t),await r.done}async function j(e,t){const n=q(e),a=(await se()).transaction(D,"readwrite"),i=a.objectStore(D),s=await i.get(n),o=t(s);return o===void 0?await i.delete(n):await i.put(o,n),await a.done,o&&(!s||s.fid!==o.fid)&&rt(e,o.fid),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oe(e){let t;const n=await j(e.appConfig,r=>{const a=ha(r),i=ma(e,a);return t=i.registrationPromise,i.installationEntry});return n.fid===ae?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function ha(e){const t=e||{fid:ia(),registrationStatus:0};return ot(t)}function ma(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const a=Promise.reject(_.create("app-offline"));return{installationEntry:t,registrationPromise:a}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=pa(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:fa(e)}:{installationEntry:t}}async function pa(e,t){try{const n=await na(e,t);return M(e.appConfig,n)}catch(n){throw Je(n)&&n.customData.serverCode===409?await st(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function fa(e){let t=await Ne(e.appConfig);for(;t.registrationStatus===1;)await nt(100),t=await Ne(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await oe(e);return r||n}return t}function Ne(e){return j(e,t=>{if(!t)throw _.create("installation-not-found");return ot(t)})}function ot(e){return ga(e)?{fid:e.fid,registrationStatus:0}:e}function ga(e){return e.registrationStatus===1&&e.registrationTime+Ge<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ct="installations",_a="installations-internal",Da=e=>{const t=e.getProvider("app").getImmediate(),n=Ca(t),r=F(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Oa=e=>{const t=e.getProvider("app").getImmediate(),n=F(t,ct).getImmediate();return{getId:()=>Sa(n),getToken:a=>Ta(n,a)}};function Ba(){C(new S(ct,Da,"PUBLIC")),C(new S(_a,Oa,"PRIVATE"))}Ba();A(We,ie);A(We,ie,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const L="analytics",Ra="firebase_id",Ha="origin",Pa=60*1e3,$a="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",ce="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
