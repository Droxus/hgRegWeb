 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uu="FirebaseError";class Wt extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=uu,Object.setPrototypeOf(this,Wt.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Jn.prototype.create)}}class Jn{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],l=o?cu(o,r):"Error",c=`${this.serviceName}: ${l} (${s}).`;return new Wt(s,c,r)}}function cu(n,t){return n.replace(hu,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const hu=/\{\$([^}]+)}/g;function Ln(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],l=t[s];if(Cs(o)&&Cs(l)){if(!Ln(o,l))return!1}else if(o!==l)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function Cs(n){return n!==null&&typeof n=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gu{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const r=new nu;if(this.instancesDeferred.set(e,r),this.isInitialized(e)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:e});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const r=this.normalizeInstanceIdentifier(t==null?void 0:t.identifier),s=(e=t==null?void 0:t.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(o){if(s)return null;throw o}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(_u(t))try{this.getOrInitializeService({instanceIdentifier:te})}catch{}for(const[e,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(e);try{const o=this.getOrInitializeService({instanceIdentifier:s});r.resolve(o)}catch{}}}}clearInstance(t=te){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){const t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=te){return this.instances.has(t)}getOptions(t=te){return this.instancesOptions.get(t)||{}}initialize(t={}){const{options:e={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:e});for(const[o,l]of this.instancesDeferred.entries()){const c=this.normalizeInstanceIdentifier(o);r===c&&l.resolve(s)}return s}onInit(t,e){var r;const s=this.normalizeInstanceIdentifier(e),o=(r=this.onInitCallbacks.get(s))!==null&&r!==void 0?r:new Set;o.add(t),this.onInitCallbacks.set(s,o);const l=this.instances.get(s);return l&&t(l,s),()=>{o.delete(t)}}invokeOnInitCallbacks(t,e){const r=this.onInitCallbacks.get(e);if(r)for(const s of r)try{s(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:yu(t),options:e}),this.instances.set(t,r),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=te){return this.component?this.component.multipleInstances?t:te:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function yu(n){return n===te?void 0:n}function _u(n){return n.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc=ac;function Vo(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r=Object.assign({name:Kr,automaticDataCollectionEnabled:!1},t),s=r.name;if(typeof s!="string"||!s)throw $t.create("bad-app-name",{appName:String(s)});if(e||(e=bo()),!e)throw $t.create("no-options");const o=Fn.get(s);if(o){if(Ln(e,o.options)&&Ln(r,o.config))return o;throw $t.create("duplicate-app",{appName:s})}const l=new vu(s);for(const d of Wr.values())l.addComponent(d);const c=new hc(e,r,l);return Fn.set(s,c),c}function Do(n=Kr){const t=Fn.get(n);if(!t&&n===Kr&&bo())return Vo();if(!t)throw $t.create("no-app",{appName:n});return t}function bt(n,t,e){var r;let s=(r=lc[n])!==null&&r!==void 0?r:n;e&&(s+=`-${e}`);const o=s.match(/\s|\//),l=t.match(/\s|\//);if(o||l){const c=[`Unable to register library "${s}" with version "${t}":`];o&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&l&&c.push("and"),l&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),kt.warn(c.join(" "));return}qt(new xt(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc="firebase-heartbeat-database",pc=1,Ye="firebase-heartbeat-store";let Lr=null;function xo(){return Lr||(Lr=No(fc,pc,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(Ye)}catch(e){console.warn(e)}}}}).catch(n=>{throw $t.create("idb-open",{originalErrorMessage:n.message})})),Lr}async function mc(n){try{const e=(await xo()).transaction(Ye),r=await e.objectStore(Ye).get(ko(n));return await e.done,r}catch(t){if(t instanceof Wt)kt.warn(t.message);else{const e=$t.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});kt.warn(e.message)}}}async function Ms(n,t){try{const r=(await xo()).transaction(Ye,"readwrite");await r.objectStore(Ye).put(t,ko(n)),await r.done}catch(e){if(e instanceof Wt)kt.warn(e.message);else{const r=$t.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});kt.warn(r.message)}}}function ko(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tc(n){qt(new xt("platform-logger",t=>new ku(t),"PRIVATE")),qt(new xt("heartbeat",t=>new _c(t),"PRIVATE")),bt(Gr,ks,n),bt(Gr,ks,"esm2017"),bt("fire-js","")}Tc("");var Ic="firebase",Ac="10.13.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Go=new Map;function Ko(n,t){const e=Zn(n);Wo(e,t),Lc(e,t)}function Wo(n,t){const e=Go.get(n);if(e)for(const r of e)r(t)}function Lc(n,t){const e=Fc();e&&e.postMessage({key:n,fid:t}),Bc()}let ee=null;function Fc(){return!ee&&"BroadcastChannel"in self&&(ee=new BroadcastChannel("[Firebase] FID Change"),ee.onmessage=n=>{Wo(n.data.key,n.data.fid)}),ee}function Bc(){Go.size===0&&ee&&(ee.close(),ee=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uc="firebase-installations-database",$c=1,ae="firebase-installations-store";let Fr=null;function li(){return Fr||(Fr=No(Uc,$c,{upgrade:(n,t)=>{switch(t){case 0:n.createObjectStore(ae)}}})),Fr}async function Bn(n,t){const e=Zn(n),s=(await li()).transaction(ae,"readwrite"),o=s.objectStore(ae),l=await o.get(e);return await o.put(t,e),await s.done,(!l||l.fid!==t.fid)&&Ko(n,t.fid),t}async function Qo(n){const t=Zn(n),r=(await li()).transaction(ae,"readwrite");await r.objectStore(ae).delete(t),await r.done}async function tr(n,t){const e=Zn(n),s=(await li()).transaction(ae,"readwrite"),o=s.objectStore(ae),l=await o.get(e),c=t(l);return c===void 0?await o.delete(e):await o.put(c,e),await s.done,c&&(!l||l.fid!==c.fid)&&Ko(n,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pi(n){var t,e;return((e=(((t=n==null?void 0:n.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||e===void 0?void 0:e.stringValue)==="server_timestamp"}function ma(n){const t=n.mapValue.fields.__previous_value__;return pi(t)?ma(t):t}function qn(n){const t=ce(n.mapValue.fields.__local_write_time__.timestampValue);return new tt(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ri{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Ri(this.firestore,t,this._query)}}class Dt{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new jt(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new Dt(this.firestore,t,this._key)}}class jt extends Ri{constructor(t,e,r){super(t,e,Td(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new Dt(this.firestore,null,new k(t))}withConverter(t){return new jt(this.firestore,t,this._path)}}function ip(n,t,...e){if(n=se(n),Wa("collection","path",t),n instanceof ur){const r=W.fromString(t,...e);return Eo(r),new jt(n,null,r)}{if(!(n instanceof Dt||n instanceof jt))throw new x(R.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(W.fromString(t,...e));return Eo(r),new jt(n.firestore,null,r)}}function sp(n,t,...e){if(n=se(n),arguments.length===1&&(t=ha.newId()),Wa("doc","path",t),n instanceof ur){const r=W.fromString(t,...e);return vo(r),new Dt(n,null,new k(r))}{if(!(n instanceof Dt||n instanceof jt))throw new x(R.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(W.fromString(t,...e));return vo(r),new Dt(n.firestore,n instanceof jt?n.converter:null,new k(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
и возврат средств и т.д. и т.п.`};function cl(n){const t=document.getElementById(n);for(;t.firstChild;)t.removeChild(t.firstChild)}function kp(){Array.from(document.getElementsByClassName("serviceBtns")).forEach(n=>{n.addEventListener("click",()=>{const t=n.getAttribute("service-name");Kt=Yn[t],Gp()})})}function Op(){kp()}function Bt(n,t,e){Array.from(document.getElementsByClassName(n)).forEach(r=>{r.addEventListener(t,e)})}function Mp(n){this.style.height="auto",this.style.height=this.scrollHeight+"px";const t=n.target,e=t.value.length,r=t.getAttribute("maxlength"),s=t.parentElement.getElementsByClassName("inputHelper")[0];e>r&&(t.value=t.value.substring(0,r)),s.textContent=`${t.value.length}/${r} characters used`}function Lp(n){if(n){const t=n.parentElement.getElementsByClassName("inputError")[0];t&&(console.log("show error"),t.style.display="block"),n.style.outline="1px solid "+ul,n.scrollIntoView({behavior:"smooth",block:"center"}),setTimeout(()=>{t.style.display="none",n.style.outline="none"},3e3)}}function Fp(){const n=ll[Kt];if(n==null)return;const t={};for(const[e,r]of Object.entries(n)){const s=wp(r),o=document.getElementById(r.id);if(s)t[e]=o.value??"";else{Lp(o);return}}return t}let Io;function Bp(){clearTimeout(Io),Io=setTimeout(()=>{document.getElementById("submitErrorLbl").style.color="transparent"},5e3),document.getElementById("submitErrorLbl").style.color=ul}function Up(){cl("app");const e=Kt==Yn.BASIC||Kt==Yn.ADVANCED?`Спасибо! <br>Мы свяжемся с вами сразу как только получим для вас точную дату подачи 
  ...
  `),document.getElementById("updPagebtn").addEventListener("click",()=>{location.reload()})}async function $p(){console.log("submit btn clicked");const n=Fp();n==null&&Bp(),console.log(n),await Ap(n,Kt),Up()}function jp(){Bt("passport","input",Pp),Bt("onlyDigits","input",bp),Bt("onlyText","input",Sp),Bt("onlyAllText","input",Rp),Bt("phone","input",Cp),Bt("email","input",Np),Bt("date","input",Vp),Bt("textarea","input",Mp),document.getElementById("submitBtn").addEventListener("click",$p)}function qp(n){const{id:t,fieldName:e,type:r,className:s,labelName:o,placeholder:l,maxlength:c,minlength:d,required:f,inputHelper:I}=n;return r=="textarea"?`
  ...
  `:`
    ...
    `}function Hp(){const n=document.getElementById("formContainer"),t=`
  <header>
    <div id="formPageHeader">
      <div class="iconLogotype"></div>
      <label id="formHeaderServiceNameLbl">${Dp[Kt]}</label>
      <label id="formHeaderExplanationLbl">${xp[Kt]}</label>
      <div id="formHeaderBtnsBlock">
        <button id="formHeaderGoBackBtn">Выбрать другую услугу</button>
      </div>
    </div>
  </header>
  `;n.insertAdjacentHTML("beforeend",t)}function zp(){cl("app"),document.getElementById("app").insertAdjacentHTML("beforeend",'<div id="formContainer"></div>'),Hp();const n=ll[Kt]??{},t=document.getElementById("formContainer");Object.entries(n).forEach(([e,r])=>{const s=qp(r);t.insertAdjacentHTML("beforeend",s)}),t.insertAdjacentHTML("beforeend",`
    <label id="submitErrorLbl">The form cannot be submitted with invalid data</label>
     <button id="submitBtn">Отправить</button>`),document.getElementById("formHeaderGoBackBtn").addEventListener("click",()=>{location.reload()})}function Gp(){zp(),jp()}function Kp(){Op()}Kp();
